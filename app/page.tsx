    ...
    <SiteFrame page="home">
      ...
      <section className="editorial-section" aria-labelledby="news-title">
        ...
        <div>
          ...
          <p className="news-reprint"><a href="https://we-are.usc.edu/2024/05/23/international-student-graduates-with-4-bachelors-degrees-from-usc-dornsife/">Also featured in We Are SC <span className="link-arrow" aria-hidden="true">↗</span></a> · <time dateTime="2024-05-23">May 23, 2024</time></p>
          </article>
