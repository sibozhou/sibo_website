    ...
    <SiteFrame page="home" language={language}>
      <section className="intro home-intro" aria-labelledby="intro-title">
        ...
        <div className="intro-copy">
          <p>{zh ? "我目前在" : "I am a Predoctoral Scholar at "}<a href="https://haas.berkeley.edu/">{zh ? "加州大学伯克利分校哈斯商学院" : "UC Berkeley Haas"}</a>{zh ? "担任初级研究专员，同时在" : " and a Research Statistician at the "}<a href="https://www.va.gov/">{zh ? "美国退伍军人事务部（VA）" : "VA"}</a>{zh ? "担任研究统计师，与 " : ", working with "}<a href="https://haas.berkeley.edu/faculty/david-chan/">{zh ? "David Chan 教授" : "Prof. David Chan"}</a>{zh ? "合作开展研究。" : "."}</p>
