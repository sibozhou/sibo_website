    ...
    <SiteFrame page="home" language={language}>
      <section className="intro home-intro" aria-labelledby="intro-title">
        ...
        <div className="intro-copy">
          ...
          <p>{zh ? <>{t("此外，我与")}<a href="https://brown.edu/">{t("布朗大学")}</a>的 </> : "I also collaborate with "}<a href="https://neurosurgery.med.brown.edu/people/eric-t-wong-md">{zh ? "Eric T. Wong 教授" : "Prof. Eric T. Wong"}</a>{zh ? t("合作，开展神经肿瘤疾病研究。") : <> at <a href="https://brown.edu/">Brown University</a> on studies in neuro-oncology.</>}</p>
        </div>
