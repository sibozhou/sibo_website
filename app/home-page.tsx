    ...
    <SiteFrame page="home" language={language}>
      <section className="intro home-intro" aria-labelledby="intro-title">
        <div className="hero-heading">
          <h1 id="intro-title">{zh ? <a className="calligraphy-link" href="https://digitalarchive.npm.gov.tw/Collection/Detail/14960?dep=P" title={t("查看书法典藏来源")}><span className="sr-only">周思博</span><span className="calligraphy-name" aria-hidden="true"><span className="calligraphy-zhou" /><span className="calligraphy-si" /><span className="calligraphy-bo" /></span></a> : "Sibo Zhou"}</h1>
        ...
        <div className="intro-copy">
          <p>{zh ? "我在" : "I am a Predoctoral Scholar and Junior Specialist at "}<a href="https://haas.berkeley.edu/">{zh ? t("加州大学伯克利分校哈斯商学院") : "UC Berkeley Haas"}</a>{zh ? t("担任研究专员，与 ") : ", working with "}<a href="https://haas.berkeley.edu/faculty/david-chan/">{zh ? "David Chan 教授" : "Prof. David Chan"}</a>{zh ? t("合作开展健康经济学研究。") : " on health economics research."}</p>
