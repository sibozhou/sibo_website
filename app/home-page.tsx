    ...
    <SiteFrame page="home" language={language}>
      <section className="intro home-intro" aria-labelledby="intro-title">
        ...
        <div className="intro-copy">
          <p>{zh ? "我目前在" : "I am a Predoctoral Scholar at "}<a href="https://haas.berkeley.edu/">{zh ? t("加州大学伯克利分校哈斯商学院") : "UC Berkeley Haas"}</a>{zh ? t("担任研究专员，同时在") : " and a Research Statistician at the "}<a href="https://www.va.gov/">{zh ? t("美国退伍军人事务部（VA）") : "VA"}</a>{zh ? t("担任研究统计师，与 ") : ", working with "}<a href="https://haas.berkeley.edu/faculty/david-chan/">{zh ? "David Chan 教授" : "Prof. David Chan"}</a>{zh ? t("合作开展研究。") : "."}</p>
          <p>{zh ? t("我的研究兴趣涵盖健康经济学、机器学习与统计学。数学、经济学与人文学科的学习经历，使我关注如何将定量方法与对人类行为的理解相结合，探索健康与福祉相关的问题。") : "My interests span health economics, machine learning, and statistics. With a background in mathematics, economics, and the humanities, I am interested in combining quantitative methods with an understanding of human behavior to study health and well-being."}</p>
          <p>{zh ? <>{t("此外，我与")}<a href="https://brown.edu/">{t("布朗大学")}</a>的 </> : "I also collaborate with "}<a href="https://neurosurgery.med.brown.edu/people/eric-t-wong-md">{zh ? "Eric T. Wong 教授" : "Prof. Eric T. Wong"}</a>{zh ? t("合作，开展神经肿瘤疾病自然病程研究。") : <> at <a href="https://brown.edu/">Brown University</a> on natural-history studies in neuro-oncology.</>}</p>
        </div>
      ...
      <section className="editorial-section" aria-labelledby="background-title">
        ...
        <div className="section-body">
          <p>{zh ? <>{t("我于 2026 年获得")}<a href="https://brown.edu/">{t("布朗大学")}</a>{t("数据科学硕士学位。此前，我在")}<a href="https://usc.edu/">{t("南加州大学")}</a>{t("学习应用数学、经济学与数据科学、宗教学及全球研究。")}</> : <>I received my Sc.M. in Data Science from <a href="https://brown.edu/">Brown University</a> in 2026. Previously, I studied applied and computational mathematics, economics and data science, religious studies, and global studies at the <a href="https://usc.edu/">University of Southern California</a>.</>}</p>
          <p>{zh ? <>在加入<a href="https://haas.berkeley.edu/">{t("伯克利哈斯商学院")}</a>{t("与")}<a href="https://www.va.gov/">{t("美国退伍军人事务部")}</a>{t("之前，我曾担任研究助理，与")}<a href="https://brown.edu/">{t("布朗大学")}</a>的 </> : <>Before joining <a href="https://haas.berkeley.edu/">Berkeley Haas</a> and the <a href="https://www.va.gov/">VA</a>, I worked with </>}<a href="https://home.watson.brown.edu/people/faculty/watson-faculty/robert-blair">{zh ? "Robert Blair 教授" : "Prof. Robert Blair"}</a>{zh ? <>及<a href="https://usc.edu/">{t("南加州大学")}</a>的 </> : <> at <a href="https://brown.edu/">Brown</a> and </>}<a href="https://dornsife.usc.edu/profile/yuehao-bai/">{zh ? "Yuehao Bai 教授" : "Prof. Yuehao Bai"}</a>{zh ? t("合作。我也曾在 Rocket Mortgage 担任数据科学实习生，并在安永（EY）担任精算咨询实习生。") : <> at <a href="https://usc.edu/">USC</a> as a Research Assistant. My industry experience includes internships in data science at Rocket Mortgage and actuarial consulting at EY.</>}</p>
        </div>
      </section>
      <section className="editorial-section" aria-labelledby="news-title">
        ...
        <div>
          ...
          <p className="news-reprint"><a href="https://we-are.usc.edu/2024/05/23/international-student-graduates-with-4-bachelors-degrees-from-usc-dornsife/">{zh ? t("另见 We Are SC 报道") : "Also featured in We Are SC"}</a> · <time dateTime="2024-05-23">{zh ? "2024 年 5 月 23 日" : "May 23, 2024"}</time></p>
          </article>
          {zh && (
            <article className="news-story">
          ...
          <ul className="recognition-links">
            ...
            <li>
              <a href="https://dornsife.usc.edu/dornsife-scholars-program/2024-dornsife-scholar-award-recipients/">{zh ? t("南加州大学 Dornsife Scholar 奖") : "USC Dornsife Scholar Award"}</a>
      ...
      <section className="editorial-section contact-section" aria-labelledby="contact-title">
        <h2 className="section-label" id="contact-title">{zh ? t("联系我") : "Get in touch"}</h2>
        <div className="section-body">
