...
export function HomePage({ language = "en" }: { language?: Language }) {
  ...
  return (
    <SiteFrame page="home" language={language}>
      ...
      <section className="editorial-section background-section" aria-labelledby="background-title">
        <h2 className="section-label" id="background-title">{zh ? t("教育与经历") : "Background"}</h2>
        <div className="section-body background-body">
      ...
      <section className="editorial-section media-section" aria-labelledby="news-title">
